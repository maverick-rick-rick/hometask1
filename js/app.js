import {
  ...
  moveNote,
  rerenderNoteTables,
  rerenderQuantityTable,
  fillFormWithExistingNote,
  editExistingNote,
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const noteCategories = document.querySelector(
    ".note_categories > .container"
  );
  ...
  const archiveListButton = document.querySelector(
    ".table_headline-buttons > .btn-archive"
  );
  ...
  document.addEventListener("click", function (e) {
    ...
    if (targetButtonSign) {
      ...
      popupContent.innerHTML = "";
      let editNoteForm = fillFormWithExistingNote(
        currentNoteIndex,
        typeOfParentTable
      );
